...
let CommonDialogHelper = class CommonDialogHelper {
    ...
    confirm(question, cancellable) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = cancellable
                ? new common_dialog_1.CommonDialogModel(common_dialog_1.CommonDialogType.ConfirmationCancel, question)
                : new common_dialog_1.CommonDialogModel(common_dialog_1.CommonDialogType.Confirmation, question);
            const result = yield this.dialogService.open({ viewModel: common_dialog_1.CommonDialog, model: model });
            return result;
        });
    }
    /**
   ...
   */
    message(message, dialogType) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = new common_dialog_1.CommonDialogModel(dialogType, message);
            const result = yield this.dialogService.open({ viewModel: common_dialog_1.CommonDialog, model: model });
            return result;
        });
    }
