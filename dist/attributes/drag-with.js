...
var DragWithCustomAttribute = /** @class */ (function () {
    function DragWithCustomAttribute(element) {
        this.value = '';
        this.startX = 0;
        this.startY = 0;
        this.element = element;
    }
    DragWithCustomAttribute.prototype.attached = function () {
        this.valueChanged();
    };
    DragWithCustomAttribute.prototype.valueChanged = function () {
        if (!!this.value) {
            this.initTarget();
        }
    };
    DragWithCustomAttribute.prototype.initTarget = function () {
        var _this = this;
    ...
    DragWithCustomAttribute.prototype.init = function (event) {
    ...
    DragWithCustomAttribute.prototype.pan = function (e) {
        this.element.style.top = this.startY + e.deltaY + 'px';
        this.element.style.left = this.startX + e.deltaX + 'px';
    };
    DragWithCustomAttribute = __decorate([
        aurelia_framework_1.autoinject,
        aurelia_framework_1.customAttribute('drag-with'),
        __metadata("design:paramtypes", [Element])
    ], DragWithCustomAttribute);
    return DragWithCustomAttribute;
}());
exports.DragWithCustomAttribute = DragWithCustomAttribute;
