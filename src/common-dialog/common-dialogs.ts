...
CommonDialogs.types.set(
    ...
    new CommonDialogInfo("Bevestiging", "alert-info", [CommonDialogButton.Yes, CommonDialogButton.No], "fas fa-1_5x fa-question-circle"));
CommonDialogs.types.set(
    CommonDialogType.ConfirmationCancel,
    new CommonDialogInfo("Bevestiging", "alert-info", [CommonDialogButton.Yes, CommonDialogButton.No, CommonDialogButton.Cancel], "fas fa-1_5x fa-question-circle"));
CommonDialogs.types.set(
