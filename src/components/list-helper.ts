...
export class ListHelper<T> {
    ...
    public filter(array: T[], filter: string | T, included?: string[]): T[] {
        ...
        if (typeof filter === "string") {
            ...
            list.forEach(current => { stringResult = stringResult.filter((item: T) => this.filterFunc(item, current, included)); });
            return stringResult;
        }

        const filterObject: any = filter;
        let result = array;
     ...
     */
    private filterOnProperty(array: T[], value: string, included: string[] | undefined, property?: string): T[] {
     ...
     * @param property The property to filter on, or null when the filter applies to all properties
     */
    private filterFunc(item: any, value: string, included: string[] | undefined, property?: string): boolean {
     ...
     * @param included The array op property names to include
     */
    private filterAll(item: any, value: string, included: string[] | undefined): boolean {
